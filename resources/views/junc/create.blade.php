...
<body>
    <div class="container">
        ...
        <a href="{{ url('juncs') }}" class="btn btn-info">All Juncs</a>
        <form action="{{ url('store-junc') }}" method="post">
            {{ csrf_field() }}
            @if(Session::has('err'))
            ...
            <div class="form-group">
                ...
                <label class="form-check">
                    <input class="form-check-input" type="checkbox" name="skill[]" value="CSS">CSS
                </label>
                <label class="form-check">
                    <input class="form-check-input" type="checkbox" name="skill[]" value="JavaScript">JAVASCRIPT
                </label>
                <label class="form-check">
                    <input class="form-check-input" type="checkbox" name="skill[]" value="PHP">PHP
                </label>
                <label class="form-check">
